...
![](./img/from_macro_to_Autoconf.webp)

#### Authentication Template with dot1x/MAB
![](./img/authentication_dot1x_MAB.webp)
![](./img/authentication_dot1x_MAB_1.webp)
- (*) MAB: MAC Authentication Bypass
![](./img/authentication_dot1x_MAB_2.webp)
...
- In GUI:
![](./img/ap_join_config_verification.webp)
...
![](./img/ap_provisioning_WLC_verification.webp)
...
![](./img/client_onboarding_wlc_verification_2.webp)
- The Fabric WLANs are now in enable state and clients can join
![](./img/client_onboarding_wlc_verification_3.webp)
...
![](./img/client_join_wlc_verification.webp)
