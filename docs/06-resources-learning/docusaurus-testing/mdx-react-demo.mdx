...
<AlertBox type="info" title="Live Code Limitations">
  Docusaurus Live Code Editor chỉ hỗ trợ **JavaScript/React**. Python cần các tools khác như Pyodide hoặc external sandboxes.
</AlertBox>
...
<AlertBox type="warning" title="Python Live Code Limitation">
  Docusaurus **không hỗ trợ Python live code** mặc định. Chỉ có **static syntax highlighting** cho Python.
</AlertBox>
